...
public class Tag {
    ...
    private void init(int id, String text, int tagTextColor, float tagTextSize,
        ...
        this.layoutBackgrounf = layoutColor;
    ...
    public void setLayoutBackground(int layoutColor) {
        this.layoutBackgrounf = layoutColor;
    }
    ...
    public int getLayoutBackgrounf() {
        return layoutBackgrounf;
    }
