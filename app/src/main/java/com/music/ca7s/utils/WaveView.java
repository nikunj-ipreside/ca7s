...
public class WaveView extends View {
    ...
    private static final int DEFAULT_WAVE_COLOR = Color.parseColor("#D471AD");
...
//        float xAxisPosition = canvas.getHeight() * (xAxisPositionMultiplier*3);
        float xAxisPosition = (float) (canvas.getHeight() /(1.5));
