...
public class TutorialPrefrences {

    Context context;
    SharedPreferences sharedPref;
    SharedPreferences.Editor editor;

    public TutorialPrefrences(Context context) {
        this.context = context;
        sharedPref = context.getSharedPreferences(SharedPref.prefName1, Context.MODE_PRIVATE);
